...
class ListABoard extends Component {
  ...
  render() {
    ...
    if (this.state.boardJustPosted) {
      return (
        <div>
          <div className="page-header">Shop Listing</div>
          <div className="create-account t-center">
        ...
        <div className="create-account">
          ...
          <div className="hide-mobile">
            ...
            <div className="login-form__field m-t-30 m-b-0">
              ...
              >
                {this.state.imageLoading ? (
                  <div>
                    <div className="t-sans t-center">
                      Uploading and optimizing image <br />{' '}
                      <small>( This can take several seconds )</small>
                    </div>
            ...
            {this.state.postError ? (
              <div className="t-sans t-center" style={{ color: 'red' }}>
                <b>{this.state.postErrorMessage}</b>
              </div>
            ) : (
              ''
            )}
