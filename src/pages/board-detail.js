...
class BoardDetail extends PureComponent {
  ...
  sendOffer() {
    ...
    updates[
      `users/${sellerId}/offersReceived/${boardId}/name`
    ] = this.state.board.name;
  ...
  renderPhoto() {
    ...
    return (
      <img
        ...
        src={this.state.board.featurePhotoURL}
      />
    );
  }
  ...
  sendMessage() {
   ...
   // const url = 'http://localhost:8081';
    ...
    updates[
      '/users/' + sellerId + '/messagePreviews/' + messageThreadId + '/from'
    ] = buyerId;
    updates[
      '/users/' + sellerId + '/messagePreviews/' + messageThreadId + '/read'
    ] = false;
    updates[
      '/users/' +
        sellerId +
    ...
    updates[
      '/users/' + buyerId + '/messagePreviews/' + messageThreadId + '/to'
    ] = sellerId;
    updates[
      '/users/' + buyerId + '/messagePreviews/' + messageThreadId + '/read'
    ] = true;
    updates[
      '/users/' +
        buyerId +
    ...
    updates[
      '/users/' + buyerId + '/messagePreviews/' + messageThreadId + '/boardName'
    ] = this.state.board.name;
    updates[
      '/users/' +
        buyerId +
  ...
  render() {
    return (
      <div className="site-container">
        ...
        >
          <a href="https://ecosciences.com/">
            <img className="ad" src={require('../layouts/images/ad.jpg')} />
          </a>
        </div>
          ...
          <div className="inquiry-popup">
            <div className="message-box">
              ...
              <div className="message-box__content">
                  ...
                  <div>
                    ...
                    {this.state.isQuestion ? (
                      ...
                      <div>
                        ...
                        >
                          {' '}
                          If seller will ship, make sure to include shipping
                          cost in your offer! If you do not know the shipping
                          cost, message them to get a price.
                        </div>
                        <input
                          type="number"
                ...
                <div className="t-sans f-13 fc-green ">
        ...
        <div className="board-info">
          <div
            className="board-info__column__lg"
          ...
          >
            ...
            <div className="board-info__tags" style={{ marginTop: '0px' }}>
              ...
              {this.state.board.tag_advanced ? (
                <div className="board-info__tag">Advanced Rider</div>
              ) : (
                ''
              )}
              {this.state.board.tag_beginner ? (
                <div className="board-info__tag">Beginners</div>
              ) : (
                ''
              )}
              {this.state.board.tag_greatforanybody ? (
                <div className="board-info__tag">Anybody</div>
              ) : (
                ''
              )}
              ...
              {this.state.board.tag_budget ? (
                <div className="board-info__tag">On a Budget</div>
              ) : (
                ''
              )}
              {this.state.board.tag_smallwaves ? (
                <div className="board-info__tag">Small Waves</div>
              ) : (
                ''
              )}
            </div>
            ...
            <div className="board-info__section">
              <div className="board-info__section-row t-sans f-16">
                <label className="fw-500 t-upper ls-2 f-11 mw-150p">
                  Dimensions:
                </label>
          ...
          <div className="board-info__column__sm">
            ...
            <div className="board-info__images">
              <div
                ...
                style={{
                  backgroundImage: 'url(' + this.state.board.photoOne + ')'
                }}
              />
              <div
                className="board-info__image"
                style={{
                  backgroundImage: 'url(' + this.state.board.photoTwo + ')'
                }}
              />
              <div
                className="board-info__image"
                style={{
                  backgroundImage: 'url(' + this.state.board.photoThree + ')'
                }}
              />
              <div
                className="board-info__image"
                style={{
                  backgroundImage: 'url(' + this.state.board.photoFour + ')'
                }}
              />
              <div
                className="board-info__image"
                style={{
                  backgroundImage: 'url(' + this.state.board.photoFive + ')'
                }}
              />
              <div
                className="board-info__image"
                style={{
                  backgroundImage: 'url(' + this.state.board.photoSix + ')'
                }}
              />
            </div>
          </div>
