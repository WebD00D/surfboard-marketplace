      ...
      fire
        ...
        .then(
          function() {
            ...
            if (code) {
              fetch(
                `${url}/send-new-seller-email?email=${
              ...
              fetch(
                `${url}/stripe-registration?code=${code}`
              )
                .then(function(response) {
        ...
        <div className="site-container--sm">
          <div>
            <div>
              ...
              >
                Welcome to the Surf Club selling community. The go-to place for
              ...
              <p
                ...
                style={{ fontWeight: 400, fontSize: 14 }}
              >
                To view your current balance, go to your Surf Club account page,
                click Settings, click “Stripe Dashboard”. This is how you view
                your Surf Club payout history (Proceeds from the boards you have
